...
```
### SVC classifier
```{python SVC Classifier, echo=TRUE, eval=FALSE}
### Python code
...
plt.plot(svmcfpr,svmctpr,color='green',lw=lw,label='SVC AUC= %0.4f' % svmc_auc)
...
```{r Relative Influence0, echo=TRUE, include=FALSE}
### Relative Influence
